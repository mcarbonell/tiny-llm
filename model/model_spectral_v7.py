...
class SpectralThinker(nn.Module):
    def __init__(self, args: SpectralArgs):
        ...
        # C) SPECTRAL OUTPUT HEAD (Reduce Output Tax)
        self.output = DCTLinear(args.dim, args.vocab_size, k_in=args.k_vocab, k_out=args.k_vocab, bias=False)
